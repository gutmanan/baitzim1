...
public class Room {
	...
	public Room(int roomNum, int maxNumOfParticipants, int minNumOfParticipants, int timeLimit, E_Rooms roomType,
			Branch branch) {
		super();
	...
	public Room(int roomNum) {
		this.roomNum = roomNum;
		this.roomRuns = new RoomRun[Constants.MIN_LESSONS_FOR_ROOM];
	}
	...
	public String toString() {
		return "Room [roomNum=" + roomNum + ", maxNumOfParticipants=" + maxNumOfParticipants + ", minNumOfParticipants="
				+ minNumOfParticipants + ", timeLimit=" + timeLimit + ", roomType=" + roomType + ", branch=" + branch
				+ ", roomRuns=" + Arrays.toString(roomRuns) + "]";
	}
